...
export const DEFAULT_PROFILE: RegionProfile = {
  ...
  exposure: 0.92, // tuned with the LUT for a grounded daylight (not blown out)
};
...
const RAW: RegionProfile[] = [
  { id: "bree",     radius: 22, falloff: 14, lut: "bree.cube",         ground: "paving", fog: { color: 0xe0cda0, near: 50, far: 300 }, exposure: 0.86 },
  { id: "edoras",   radius: 24, falloff: 16, lut: "edoras.cube",       ground: null,     fog: { color: 0xe8dcc0, near: 60, far: 360 }, exposure: 0.95 },
  { id: "isengard", radius: 24, falloff: 16, lut: "isengard.cube",     ground: "snow",   fog: { color: 0xbcc6cf, near: 42, far: 220 }, exposure: 0.82 },
  { id: "minas",    radius: 28, falloff: 18, lut: "minas-tirith.cube", ground: "paving", fog: { color: 0xdfe7ec, near: 80, far: 360 }, exposure: 1.02 },
  { id: "argonath", radius: 20, falloff: 14, lut: "minas-tirith.cube", ground: null,     fog: { color: 0xc8d0d4, near: 50, far: 300 }, exposure: 0.90 },
];
